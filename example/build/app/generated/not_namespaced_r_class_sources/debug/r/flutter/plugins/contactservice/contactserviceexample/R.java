...
public final class R {
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #ColorStateListItem_alpha flutter.plugins.contactservice.contactserviceexample:alpha}</code></td><td>Alpha multiplier applied to the base color.</td></tr>
     * </table>
     ...
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name flutter.plugins.contactservice.contactserviceexample:alpha
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderAuthority flutter.plugins.contactservice.contactserviceexample:fontProviderAuthority}</code></td><td>The authority of the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderCerts flutter.plugins.contactservice.contactserviceexample:fontProviderCerts}</code></td><td>The sets of hashes for the certificates the provider should be signed with.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchStrategy flutter.plugins.contactservice.contactserviceexample:fontProviderFetchStrategy}</code></td><td>The strategy to be used when fetching font data from a font provider in XML layouts.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchTimeout flutter.plugins.contactservice.contactserviceexample:fontProviderFetchTimeout}</code></td><td>The length of the timeout during fetching.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderPackage flutter.plugins.contactservice.contactserviceexample:fontProviderPackage}</code></td><td>The package for the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderQuery flutter.plugins.contactservice.contactserviceexample:fontProviderQuery}</code></td><td>The query to be sent over to the provider.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name flutter.plugins.contactservice.contactserviceexample:fontProviderAuthority
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name flutter.plugins.contactservice.contactserviceexample:fontProviderCerts
     */
     ...
     * </table>
     *
     * @attr name flutter.plugins.contactservice.contactserviceexample:fontProviderFetchStrategy
     */
     ...
     * </table>
     *
     * @attr name flutter.plugins.contactservice.contactserviceexample:fontProviderFetchTimeout
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name flutter.plugins.contactservice.contactserviceexample:fontProviderPackage
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name flutter.plugins.contactservice.contactserviceexample:fontProviderQuery
     */
     ...
     * <tr><td><code>{@link #FontFamilyFont_font flutter.plugins.contactservice.contactserviceexample:font}</code></td><td>The reference to the font file to be used.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontStyle flutter.plugins.contactservice.contactserviceexample:fontStyle}</code></td><td>The style of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontVariationSettings flutter.plugins.contactservice.contactserviceexample:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontWeight flutter.plugins.contactservice.contactserviceexample:fontWeight}</code></td><td>The weight of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_ttcIndex flutter.plugins.contactservice.contactserviceexample:ttcIndex}</code></td><td>The index of the font in the tcc font file.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name flutter.plugins.contactservice.contactserviceexample:font
     */
     ...
     * </table>
     *
     * @attr name flutter.plugins.contactservice.contactserviceexample:fontStyle
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name flutter.plugins.contactservice.contactserviceexample:fontVariationSettings
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name flutter.plugins.contactservice.contactserviceexample:fontWeight
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name flutter.plugins.contactservice.contactserviceexample:ttcIndex
     */
